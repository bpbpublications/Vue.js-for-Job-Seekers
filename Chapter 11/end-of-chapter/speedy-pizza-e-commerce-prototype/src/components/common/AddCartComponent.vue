<template>
  <div class="flex flex-col">
    ...
    <div class="flex flex-col items-end">
      ...
      <div>
        <button type="button" class="add-to-cart red-button-sm ml-4" @click="addToCart">
          Add to Cart
        </button>
      </div>
    </div>
...
import { useCart, CartItem } from '../../composables/useCart';
